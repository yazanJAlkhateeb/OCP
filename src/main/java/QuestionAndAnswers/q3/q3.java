package QuestionAndAnswers.q3;

public class q3 {
    /*Which two statements are true about localizing an application?
A. Support for new regional languages does not require recompilation of the code.///answer
...
E. Language codes use lowercase letters and region codes use uppercase letters.*////answer
}
